...
<div className='flex justify-between items-center'>
  ...
  <div className=' lg:gap-5 font-medium text-xl hidden md:flex gap-3'>
    <NavLink to={'/'}>Home </NavLink> <NavLink to={'/'}>Contacts </NavLink> <NavLink to={'/'}>Services </NavLink>
      <NavLink to={'/'}>Products </NavLink> <NavLink to={'/'}>Blogs </NavLink> <NavLink to={'/'}>About us</NavLink>
      </div> <div onClick={handleDrawer} className='md:hidden relative text-2xl cursor-pointer'>
      {drawer ? "X" : "|||"}
  </div>
  {drawer && (
  <div
