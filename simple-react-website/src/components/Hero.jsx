...
const Hero = () => {
  return (
    <div className='mt-10 relative'>
      ...
      <h1 className='text-[#38C4A1] text-4xl font-bold'>Make Your Life Easier With Our Mind-blowing <span className='text-white'>Gadgets....</span></h1>
      <p className='my-4 text-center text-white w-3/4 text-xl'>
